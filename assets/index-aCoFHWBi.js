...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(e,t,n){return new gi({name:`SphericalGaussianBlur`,defines:{SAMPLES:La,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:to(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(){return new gi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:to(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function eo(){return new gi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:to(),fragmentShader:`
	...
	`}var no=class extends Vt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $r(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `)}[e,t,n,r].forEach(e=>{e.addEventListener(`input`,m)}),m()}function Wc(){document.querySelectorAll(`.tactile-card`).forEach(e=>{e.addEventListener(`mousemove`,t=>{let n=e.getBoundingClientRect(),r=t.clientX-n.left,i=t.clientY-n.top,a=n.width/2,o=n.height/2,s=(i-o)/o*-5.5,c=(r-a)/a*5.5;e.style.transform=`perspective(800px) rotateX(${s}deg) rotateY(${c}deg) translateY(-4px)`,e.style.setProperty(`--sheen-x`,`${r/n.width*100}%`),e.style.setProperty(`--sheen-y`,`${i/n.height*100}%`)}),e.addEventListener(`mouseleave`,()=>{e.style.transform=`perspective(800px) rotateX(0deg) rotateY(0deg) translateY(0px)`})});let e=document.querySelectorAll(`[data-copy]`),t=document.getElementById(`toast-notice`);function n(e){t&&(t.textContent=e,t.classList.add(`show`),setTimeout(()=>{t.classList.remove(`show`)},2800))}e.forEach(e=>{e.addEventListener(`click`,async t=>{let r=e.getAttribute(`data-copy`),a=e.getAttribute(`data-label`)||`Details`;try{await navigator.clipboard.writeText(r),n(`COPIED ${a.toUpperCase()} TO CLIPBOARD`),i()}catch{window.prompt(`Copy to clipboard: Ctrl+C, Enter`,r)}})});let r=null;function i(){try{r||=new(window.AudioContext||window.webkitAudioContext),r.state===`suspended`&&r.resume();let e=r.createOscillator(),t=r.createGain();e.type=`triangle`,e.frequency.setValueAtTime(140,r.currentTime),e.frequency.exponentialRampToValueAtTime(30,r.currentTime+.04),t.gain.setValueAtTime(.12,r.currentTime),t.gain.exponentialRampToValueAtTime(.001,r.currentTime+.04),e.connect(t),t.connect(r.destination),e.start(),e.stop(r.currentTime+.05)}catch{}}document.querySelectorAll(`.btn, .stat-cell, .ticker-strip`).forEach(e=>{e.addEventListener(`mousedown`,()=>{i()})})}function Gc(){[{selector:`.badge-tactical`,delay:80},{selector:`.hero-title`,delay:200},{selector:`.hero-lead`,delay:350},{selector:`.hero-cta-group`,delay:480},{selector:`.hero-stats`,delay:620},{selector:`.hero-3d-wrapper`,delay:300}].forEach(({selector:e,delay:t})=>{let n=document.querySelector(e);n&&(n.style.opacity=`0`,n.style.transform=`translateY(18px)`,n.style.transition=`opacity 0.7s cubic-bezier(0.16, 1, 0.3, 1), transform 0.7s cubic-bezier(0.16, 1, 0.3, 1)`,setTimeout(()=>{n.style.opacity=`1`,n.style.transform=`translateY(0px)`},t))});let e=document.querySelectorAll(`.section, .tactile-card, .simulator-container, .contact-card`),t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`in-view`),t.unobserve(e.target))})},{threshold:.12,rootMargin:`0px 0px -50px 0px`});e.forEach(e=>{t.observe(e)})}document.addEventListener(`DOMContentLoaded`,()=>{window.lucide&&window.lucide.createIcons(),Hc(),Uc(),Wc(),Gc(),console.log(`%c [VIGNESH J — EXECUTIVE PORTFOLIO] 
%c Operations Leadership • BA Economics • Pursuing MBA 
 Direct: +91 7639743256 | vickyvji1104@gmail.com `,`background: #D4A359; color: #0B0C0E; font-weight: bold; padding: 4px 8px;`,`background: #151820; color: #F7F5F0; padding: 4px 8px;`)});